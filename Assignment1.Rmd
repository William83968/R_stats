...
sdev3= mean(values2023[1:14])
ts = c(sdev1, sdev2, sdev3)
barplot(ts, names.arg=c('2019', '2020', '2023'))
```
It seems like the hypothesis has been falsified, there was an electric usage increase, but not during the pandemic, instead after the pandemic.
It turns after some research that it's because of the rapid transition into renewable energy, understanding that it's not actually related to usage of electric equipment, the answer to the research question is that the usage of electric equipments, at least during this period of pandemic, did not led to an increase of electric usage.

## Research question 2:
So, the first hypothesis has failed, after some more research is has found that the majority of the reason 
